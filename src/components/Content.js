...
class Content extends Component {
  ...
  searchName = async e => {
    ...
    await axios
      .get(
        "https://pekenbackend.herokuapp.com/products?name=" +
          search +
          "&limit=" +
          this.state.limit
      )
  ...
  pigination = async () => {
    ...
    await axios
      .get(
        "https://pekenbackend.herokuapp.com/products?page=" +
          this.state.clicks +
          "&limit=" +
          this.state.limit
      )
  ...
  buy = async event => {
    ...
    await axios
      .post("https://pekenbackend.herokuapp.com/products/reduce", data)
      .then(res => {
        console.log(res);
      })
      .catch(err => {
  ...
  orderBy = async e => {
    ...
    await axios
      .get(
        "https://pekenbackend.herokuapp.com/products?sortBy=" +
          order +
          "&limit=" +
          this.state.limit
      )
                ...
                <div>
                  <div className="text-center mt-3">
                    <button class="btn btn-link">
                      <img
                        src={"https://pekenbackend.herokuapp.com/public/images/i.png"}
                        style={{ width: "60px" }}
                        className="rounded"
                        alt="..."
                      />
                  ...
                  <div className="text-center mt-3">
                    ...
                    >
                      <img
                        src={"https://pekenbackend.herokuapp.com/public/images/menu.jpg"}
                        style={{ width: "60px" }}
                        alt=""
                        className="rounded"
                      />
                  ...
                  <div className="text-center mt-3">
                    ...
                    >
                      <img
                        src={
                          "https://pekenbackend.herokuapp.com/public/images/logout.png"
                        }
                        style={{ width: "60px" }}
                        className="rounded"
                        alt=""
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <img
                  src={"https://pekenbackend.herokuapp.com/public/images/shopping.jpg"}
                  style={{ width: "30px" }}
                  className="rounded"
                  alt="..."
                />
